...
export function QrPreview({ previewUrl, isGenerating, inputErrors, apiError, onDownload }: QrPreviewProps) {
  ...
  return (
    <section className="flex min-h-0 flex-col gap-4 rounded-lg bg-white p-5 shadow-[0_10px_30px_rgba(74,85,130,0.07)]">
      ...
      <div className="grid min-h-0 flex-1 place-items-center rounded-md border border-[#e0e4ee] bg-white p-5 shadow-inner">
        {previewUrl ? (
      ...
      <button
        ...
        className="min-h-16 rounded-md border border-[#6a56f1] bg-white px-5 text-xl font-black text-[#5948dd] transition hover:bg-[#f7f4ff] disabled:cursor-not-allowed disabled:border-[#d6dae6] disabled:text-[#a2a8bb]"
      >
        ダウンロード
      </button>
    </section>
